...
import { TrophyIcon, LinkIcon } from './IconComponents';
    ...
    const fetchResults = async () => {
      ...
      try {
        ...
        const response = await ai.models.generateContent({
            ...
            contents: '直近の主要なテニス大会（グランドスラム、ATP/WTAツアーなど）の結果をいくつか教えてください。優勝者、準優勝者、スコアなどを簡潔にまとめてください。',
            config: {
              tools: [{googleSearch: {}}],
            },
        });
        ...
        console.error("テニス大会結果の取得に失敗しました:", err);
    ...
    if (isLoading) {
      return (
        <div className="flex flex-col items-center justify-center py-10">
          ...
          <p className="text-slate-500 mt-4">最新の大会結果を取得中...</p>
        </div>
      );
    }
    if (error) {
